...
var ReferrerKiller = (function () {
  var URL_REDIRECTION = 'https://www.baidu.com?q=', // 'https://www.google.com/url?q=', // You can use another service if you use https protocol no referrer will be sent.
    PUB = {},
    IE_GT_8 = (function () {
/* - Detecting if it's IE greater than 8 - */
  ...
  function htmlString (html, iframeAttributes) {
    ...
    var fontsize = window.parent.document.documentElement.style.fontSize
  ...
  var linkHtml = PUB.linkHtml = function (url, innerHTML, anchorParams, iframeAttributes) {
    ...
    if (!('target' in anchorParams) || anchorParams.target === '_self') {
